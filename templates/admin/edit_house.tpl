    ...
    <section class="mini-layout">
        <div class="frame_title clearfix">
            <div class="pull-left">
                ...
                <span class="title">Редактировать дом</span>
            </div>
            <div class="pull-right">
                <div class="d-i_b">
                    <a href="{$BASE_URL}admin/components/cp/map/street_houses/{$street_id}" class="t-d_n m-r_15 pjax"><span class="f-s_14">←</span> <span class="t-d_u">{lang('a_return')}</span></a>
        ...
        <form action="/admin/components/cp/map/update_house/{$id}" method="POST"  id="saveForm">
                                    ...
                                    <div class="inside_padd span9">
                                        <div class="form-horizontal">
                                            <div class="control-group m-t_10">
                                                ...
                                                <div class="controls">
                                                    <input type="text" name="house_number" value="{$house}" />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
