    ...
    <section class="mini-layout">
        <div class="frame_title clearfix">
            <div class="pull-left">
                ...
                <span class="title">Редактировать населенный пункт</span>
            </div>
            <div class="pull-right">
                <div class="d-i_b">
                    <a href="{$BASE_URL}admin/components/cp/map" class="t-d_n m-r_15 pjax"><span class="f-s_14">←</span> <span class="t-d_u">{lang('a_return')}</span></a>
        ...
        <form action="/admin/components/cp/map/update_city/{$id}" method="POST"  id="saveForm">
                                    ...
                                    <div class="inside_padd span9">
                                        <div class="form-horizontal">
											...
											<div class="control-group">
												...
												<div class="controls">
													<input type="text" class="textbox" name="city_lat" id="city_lat" value="{$lat}" />
												</div>
											</div>
											<div class="control-group">
												<label class="control-label" for="city_lng">Долгота(lng):</label>
												<div class="controls">
													<input type="text" class="textbox" name="city_lng" id="city_lng" value="{$lng}" />
												</div>
											</div>
											<div class="control-group">
												<label class="control-label" for="city_zoom">Зум(zoom):</label>
												<div class="controls">
													<input type="text" class="textbox" name="city_zoom" id="city_zoom" value="{$zoom}" />
												</div>
											</div>
                                        </div>
                                    </div>
